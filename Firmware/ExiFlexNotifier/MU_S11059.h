...
class MU_S11059 {
  ...
  private:
    ...
    const uint8_t S11059_ADR      = 0x39;
    const uint8_t S11059_COMMAND  = 0x80;
    const uint8_t TSL2572_TYPE_REP = 0x00;
    const uint8_t S11059_TYPE_INC = 0x20;
    ...
    const uint8_t S11059_AEN   = 0x02;
    const uint8_t S11059_PON   = 0x01;

    const uint8_t S11059_ENABLE   = 0x00;
    const uint8_t S11059_ATIME    = 0x01;
    ...
    const uint8_t S11059_CONFIG   = 0x0D;
    const uint8_t S11059_CONTROL  = 0x0F;
    const uint8_t S11059_ID       = 0x12;
    const uint8_t TSL2572_STATUS   = 0x13;
    const uint8_t S11059_C0DATA   = 0x14;
